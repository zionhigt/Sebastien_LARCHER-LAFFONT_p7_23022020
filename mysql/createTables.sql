...
ALTER TABLE Posts
ADD CONSTRAINT fk_post_profil_id FOREIGN KEY (profil_id) REFERENCES Profils(id) ON DELETE SET NULL;

ALTER TABLE Comments
ADD CONSTRAINT fk_post_id FOREIGN KEY (post_id) REFERENCES Posts(id) ON DELETE CASCADE;

ALTER TABLE Comments
ADD CONSTRAINT fk_comment_profil_id FOREIGN KEY (profil_id) REFERENCES Profils(id) ON DELETE SET NULL;